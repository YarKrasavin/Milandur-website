...
<section class="articles-section">
  ...
  <div class="articles-grid">
    ...
    <div class="article-card">
      <h3>Гайды</h3>
      <a href="/docs/guides" class="btn-card">Перейти в статью</a>
    </div>
    <div class="article-card">
      <h3>Правила</h3>
      <a href="/docs/rules" class="btn-card">Перейти в статью</a>
    </div>
  </div>
</section>
...
<style scoped>
  /* Сюда полностью перенеси весь свой блок <style> из твоего файла */
  /* Но удали из него стили для body (background-color, шрифт), иначе они перекроют глобальные */
  .hero { padding: 80px 0; display: grid; ... }
  .hero-title { ... }
